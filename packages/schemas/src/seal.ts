...
import { ScopeMode, OperatorDisclosures } from "./operator.js";
...
import type { ScopeModeType, OperatorDisclosuresType } from "./operator.js";
import {
  ProvenanceMap,
...
/** Trust tier surfaced on a seal when the signet can determine the runtime posture. */
...
export type SealPayloadType = {
  ...
  /** Provenance metadata for disclosed and signet-established claims. */
...
export const SealPayload: z.ZodType<SealPayloadType> = z
  .object({
     ...
     * and the signet-established trustTier claim get entries.
     */
